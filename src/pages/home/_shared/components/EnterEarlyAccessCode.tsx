...
const EnterEarlyAccessCode = () => {
  ...
  // Hooks
  const {
    data: { showSignUpForEarlyAccess },
    operations: { onAttemptEarlyAccess, onToggleSignUpForEarlyAccess },
  } = useEarlyAccess();
    ...
    <div>
      ...
      {showSignUpForEarlyAccess ? (
        <>
          ...
          <button
            className="text-white text-xs font-poppins font-bold underline mt-8"
