...
class OGC3DTilesLayer extends Layer {
  ...
  generateControlShapes(tileset) {
    ...
    if (tileset.boundingVolume instanceof OBB) {
      ...
      shape.moveTo(
        tileset.boundingVolume.center.x +
          tileset.boundingVolume.halfWidth +
          tileset.boundingVolume.halfWidth * 0.1,
        tileset.boundingVolume.center.y +
          tileset.boundingVolume.halfHeight +
          tileset.boundingVolume.halfWidth * 0.1
      );
      shape.lineTo(
        tileset.boundingVolume.center.x +
      ...
      hole.moveTo(
        tileset.boundingVolume.center.x +
          tileset.boundingVolume.halfWidth +
          tileset.boundingVolume.halfWidth * 0.0,
        tileset.boundingVolume.center.y +
          tileset.boundingVolume.halfHeight +
          tileset.boundingVolume.halfWidth * 0.0
      );
      ...
      geometry.translate(
        tileset.boundingVolume.center.x,
        tileset.boundingVolume.center.y,
        tileset.boundingVolume.center.z
      );
      ...
      const geometry2 = new THREE.BoxGeometry(
        tileset.boundingVolume.halfWidth * 2,
        tileset.boundingVolume.halfHeight * 2,
        tileset.boundingVolume.halfDepth * 2
      );
      ...
      this.boundingMesh = new THREE.Mesh(
        geometry2,
        new THREE.MeshBasicMaterial({
          color: 0xffb24e,
          transparent: true,
      ...
      this.boundingMeshOutline = new THREE.BoxHelper(
        this.boundingMesh,
        0xffb24e
      );
  ...
  setMap(map) {
    ...
    var tileLoader = !!self.properties.tileLoader
      ? self.properties.tileLoader
      : new TileLoader({
  ...
  updateLocation() {
    ...
    if (this.llh) {
      ...
      quaternionToEarthNormalOrientation.setFromUnitVectors(
        up,
        orientationHelper.copy(cartesianLocation).normalize()
      );
      quaternionSelfRotation.setFromEuler(this.rotation);
      this.tileset.quaternion
        .copy(quaternionToEarthNormalOrientation)
        .multiply(quaternionSelfRotation);
      this.tileset.position.copy(cartesianLocation);
      this.tileset.scale.set(this.scale, this.scale, this.scale);

      if (this.boundingMesh) {
        this.boundingMesh.quaternion
          .copy(quaternionToEarthNormalOrientation)
          .multiply(quaternionSelfRotation);
