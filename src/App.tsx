...
function PhotorealisticMap() {
  ...
  return (
    <div className="map-container" style={{ position: 'relative', width: '100%', height: '650px' }}>
      <div 
        ref={mapRef}
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button 
              onClick={() => {
                orbitSpeedRef.current = Math.max(0.2, orbitSpeedRef.current - 0.2);
            ...
            <button 
              onClick={() => {
                orbitSpeedRef.current = Math.min(5, orbitSpeedRef.current + 0.2);
        ...
        <div style={{ marginTop: '10px' }}>
          <p style={{ margin: '0 0 5px 0', fontWeight: 'bold' }}>Time of Day (for shadows):</p>
          <div style={{ display: 'flex', gap: '10px' }}>
            <button
